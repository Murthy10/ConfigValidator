...
class Configuration:
    def __init__(self, config_file_path=''):
        ...
        sections = [
            {'section': 'IMAGERY',
             'options': [{'option': 'url', 'fallback': 'imagery.url.org'}, {'option': 'zoomlevel', 'fallback': '19'}]},
            {'section': 'Server',
             'options': [{'option': 'name', 'fallback': 'SuperServer'}, {'option': 'host', 'fallback': '127.0.0.1'},
                         {'option': 'list', 'fallback': '1,2,3,4'}]},
        ]
